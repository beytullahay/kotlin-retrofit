...
class RecyclerViewAdapter(private val cryptoList: ArrayList<CryptoModel>, private val listener: Listener) : RecyclerView.Adapter<RecyclerViewAdapter.RowHolder>() {
    ...
    class RowHolder(view: View) : RecyclerView.ViewHolder(view) {
        fun bind (cryptoModel: CryptoModel, colors: Array<String>, position: Int, listener: Listener){
            ...
            itemView.setBackgroundColor(Color.parseColor(colors[position % 8])) // renk listesindeki renkleri sırayla yazdıracak mod 8 olarak
            val textCurrency = itemView.findViewById<TextView>(R.id.text_name)  // gelen ismi ekrana sırayla yazdıracak
